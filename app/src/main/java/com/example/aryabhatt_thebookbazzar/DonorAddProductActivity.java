...
public class DonorAddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_add_product);
...
//        addImage3 = findViewById(R.id.add_new_image3);
        ...
        managepro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DonorAddProductActivity.this, DonorManageProductActivity.class);
        ...
        myorderspro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DonorAddProductActivity.this, DonorMyOrderActivity.class);
                startActivity(intent);
            }
        });
        ...
        imagerefrence = FirebaseStorage.getInstance().getReference().child("Donate Images");
...
//                if (imageuri1 == null){
//                    Toast.makeText(DonorAddProductActivity.this, "Please select photo 1*", Toast.LENGTH_SHORT).show();
//                }else if (imageuri2 == null){
//                    Toast.makeText(DonorAddProductActivity.this, "Please select photo 2*", Toast.LENGTH_SHORT).show();
//                }else if (imageuri3 == null){
//                    Toast.makeText(DonorAddProductActivity.this, "Please select photo 3*", Toast.LENGTH_SHORT).show();
//                }else
                if (imageuri4 == null){
                    Toast.makeText(DonorAddProductActivity.this, "Please select photo 4*", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(proname)){
                    Toast.makeText(DonorAddProductActivity.this, "Please enter name.", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(prodesp)){
                    Toast.makeText(DonorAddProductActivity.this, "Please enter despcription.", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(proprice)){
                    Toast.makeText(DonorAddProductActivity.this, "Please enter price.", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void SaveProduct() {
        ...
        uploadTask4.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(DonorAddProductActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
            }
                ...
                Task<Uri> uriTask1 = uploadTask4.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(DonorAddProductActivity.this, "Product uploaded successfully.", Toast.LENGTH_SHORT).show();
                            SavedataTofirebase();
                        }
                    }
                });
...
//
//                //Toast.makeText(DonorAddProductActivity.this, "1.", Toast.LENGTH_SHORT).show();
//
...
//                        //Toast.makeText(DonorAddProductActivity.this, "2.", Toast.LENGTH_SHORT).show();
//
...
//                                final StorageReference filepath4 = imagerefrence.child(phoneuser + "Image By Seller" + imageuri4.getLastPathSegment() + datetime + ".jpg");
//                                final UploadTask uploadTask4 = filepath4.putFile(imageuri4);
//                                //Toast.makeText(DonorAddProductActivity.this, "3.", Toast.LENGTH_SHORT).show();
//
//                                uploadTask4.addOnFailureListener(new OnFailureListener() {
//                                    @Override
//                                    public void onFailure(@NonNull Exception e) {
...
//                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
//
//                                        //Toast.makeText(DonorAddProductActivity.this, "Images Uploaded Successfully...", Toast.LENGTH_SHORT).show();
//
...
//                                                if (task.isSuccessful()){
//
//                                                    //Toast.makeText(DonorAddProductActivity.this, "11.", Toast.LENGTH_SHORT).show();
//
...
//                                                            if (task.isSuccessful()){
//
//                                                                //Toast.makeText(DonorAddProductActivity.this, "22.", Toast.LENGTH_SHORT).show();
...
//                                                                        if (task.isSuccessful()){
//
//                                                                            //Toast.makeText(DonorAddProductActivity.this, "33.", Toast.LENGTH_SHORT).show();
...
//                                                                                    if (task.isSuccessful()){
//
//                                                                                        //Toast.makeText(DonorAddProductActivity.this, "44.", Toast.LENGTH_SHORT).show();
//                                                                                        downloadimageurl4 = task.getResult().toString();
//
//                                                                                        Toast.makeText(DonorAddProductActivity.this, "Product uploaded successfully.", Toast.LENGTH_SHORT).show();
//                                                                                        SavedataTofirebase();
...
//        });
    ...
    private void SavedataTofirebase() {
        ...
        productmap.put("price", "Donated 0 ");
        productmap.put("actualprice", proprice);
...
//        productmap.put("image3", downloadimageurl3);
        ...
        proref.child("Donate").child(phoneuser).child(datetime).updateChildren(productmap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    Intent intent = new Intent(DonorAddProductActivity.this, DonorActivity.class);
                    startActivity(intent);
                    loadingbar.dismiss();
                    Toast.makeText(DonorAddProductActivity.this, "Bravo!", Toast.LENGTH_SHORT).show();
                }else{
                    loadingbar.dismiss();
