...
public class SellerManageProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_manage_product);
        ...
        productref = FirebaseDatabase.getInstance().getReference().child("Products").child(phoneuser);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(SellerManageProductActivity.this, SellerCategoryChooseActivity.class);
            ...
            protected void onBindViewHolder(@NonNull ProductsViewHolder holder, int position, @NonNull final Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        //Toast.makeText(SellerManageProductActivity.this, "Well done!", Toast.LENGTH_SHORT).show();


                        AlertDialog.Builder dialog = new AlertDialog.Builder(SellerManageProductActivity.this);
                        dialog.setMessage("Delete this Product.");
                        dialog.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                String phoneuserr = Paper.book().read("phonenumber");
                                deleteref.child("Products").child(phoneuserr).child(model.getDate() + model.getTime()).removeValue();
                                deletereff.child("ProductsAll").child(phoneuserr + model.getPrice() + model.getCategory()).removeValue();
                                deleteref.child(model.getCategory()).child(phoneuserr+ model.getPrice() + model.getCategory()).removeValue();
                                Toast.makeText(SellerManageProductActivity.this, "Deleted successfully!", Toast.LENGTH_SHORT).show();
